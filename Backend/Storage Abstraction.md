...
Parent: [[Backend/Backend Overview|Backend Overview]] · [[Database Overview]]
...
5. Add the driver to `requirements.txt` and regenerate the offline wheelhouse (see [[Deployment/Air-Gap Deployment|Air-Gap Deployment]]).
...
See [[Development/Technical Debt|Technical Debt]] for the consolidated, prioritized list.

## See also

[[Database Overview]] · [[Backend/Backend Overview|Backend Overview]] · [[Deployment/Production Deployment|Production Deployment]]
