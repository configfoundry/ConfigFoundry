...
Parent: [[Repository Overview]] · [[Development/Engineering Wiki|Engineering Wiki]]

> [!NOTE]
> `tests/README.md` states "no test code exists yet" — this is **stale relative to the current codebase**. 24 test files exist across 8 subdirectories today. Flagged in [[Development/Technical Debt|Technical Debt]] as a documentation-drift item worth fixing (the README should be updated or removed).
...
[[Development/Engineering Wiki|Engineering Wiki]] · [[Development/Technical Debt|Technical Debt]] · [[Deployment/Development Setup|Development Setup]]
