...
JWT access token or an API key. See [Authentication](../security/authentication.md)
...
- Every protected endpoint additionally requires a specific permission code — see [RBAC](../security/rbac.md) for the full catalog and which system roles grant which codes.
