...
[RBAC Permission Catalog](../../security/RBAC Permission Catalog.md) (`api:manage`), [Access Policy Engine](../../security/Access Policy Engine.md) (a key's own IP allowlist is enforced independently of the global policy engine — confirm the exact interaction in `core/services/api_key_service.py` during a deeper review).

## Known limitations

Richer scoping/management UI is explicitly a v0.7.0 "deepen this" item, not a v0.5 gap — the feature already ships; see [Roadmap Overview](../../roadmap/Roadmap Overview.md).
...
[API Keys & Policies Endpoints](../../api/API Keys & Policies Endpoints.md) · [Access Policy Engine](../../security/Access Policy Engine.md)
