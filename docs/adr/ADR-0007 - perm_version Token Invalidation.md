...
[Authorization & RBAC § Immediate revocation](../security/Authorization & RBAC.md#immediate-revocation-without-a-token-blacklist) · [Authentication](../security/Authentication Overview.md)
