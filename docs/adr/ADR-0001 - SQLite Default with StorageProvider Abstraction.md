...
Parent: [ADR Index](ADR Index.md) · [Storage Abstraction](../architecture/Storage Abstraction.md)
...
[Storage Abstraction](../architecture/Storage Abstraction.md) · [Database Overview](../architecture/Database Overview.md)
