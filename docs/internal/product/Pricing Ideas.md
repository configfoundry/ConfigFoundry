...
Parent: [OSS vs Enterprise](OSS vs Enterprise.md)
...
A SaaS/hosted-by-default product, or any model requiring phone-home telemetry/licensing checks — both conflict directly with the air-gap-first, zero-telemetry design already in place (see [Repository Overview](../../reference/Repository Overview.md#external-dependencies) and `docs/faq.md`'s explicit "no telemetry, no phone-home update check" statement).

## See also

[OSS vs Enterprise](OSS vs Enterprise.md) · [Roadmap Overview](../../roadmap/Roadmap Overview.md)
