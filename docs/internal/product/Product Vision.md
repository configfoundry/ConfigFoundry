...
See [Repository Overview](../../reference/Repository Overview.md#business-problem-solved) and [Feature - Inventory Management § Known limitations](../../reference/features/Feature - Inventory Management.md#known-limitations) for the full "what this deliberately isn't."

## See also

[Target Users & Use Cases](Target Users & Use Cases.md) · [OSS vs Enterprise](OSS vs Enterprise.md) · [Roadmap Overview](../../roadmap/Roadmap Overview.md) · [Executive Summary](Executive Summary.md)
