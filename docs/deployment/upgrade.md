...
[Database Migrations § Roll back one migration](../architecture/database-migrations.md#roll-back-one-migration))
...
- [Migrations](../architecture/migrations.md) — how schema changes are applied.
- [Air-Gap Deployment](airgap.md) — regenerating vendor bundles for a
  new release before upgrading an offline install.
- [Release Process](../development/release-process.md) — what changes between
