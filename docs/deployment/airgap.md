...
[Release Process](../development/release-process.md) for how the bundle is assembled
and [Development](../development/development.md) for building the frontend from a
...
3. Every frontend JS/CSS/font/icon asset is bundled into the Next.js
   ...
   CSP/blank-page issues — see [Security](../security/security.md)).
...
[Release Process](../development/release-process.md) for where to get one), then:
...
[Release Process](../development/release-process.md) for what's inside a release
bundle.
...
[Security](../security/security.md) for how the CSP was tightened to same-origin
