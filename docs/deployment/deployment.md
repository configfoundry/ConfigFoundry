...
[Configuration](../reference/configuration.md). `SecurityHeadersMiddleware` always
...
[Storage](../architecture/storage.md) for how to switch.
...
- [Security](../security/security.md) — the full security model.
