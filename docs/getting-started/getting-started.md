...
[Installation](installation.md), [Air-Gap Deployment](../deployment/airgap.md), and
[Enterprise Deployment](../deployment/enterprise.md) instead.
...
Without internet access, see [Air-Gap Deployment](../deployment/airgap.md) — the
...
[API Reference](../api/api.md) for the full endpoint list and
[Authentication](../security/authentication.md) for how to obtain a token.

## What's next

- Running this for a team? Read [RBAC](../security/rbac.md) and set up roles before
  handing out accounts.
- Deploying somewhere without internet access? Read
  [Air-Gap Deployment](../deployment/airgap.md).
