...
// Tab strip removed -- the sidebar's Infrastructure nav group already covers
...
//
// Route renamed from /inventory/devices to /infrastructure/devices as part
// of the Infrastructure IA rename (Inventory -> Infrastructure). The
// underlying component still lives at modules/inventory/DevicesView.tsx --
// only the route and nav label changed, not the module's internal
