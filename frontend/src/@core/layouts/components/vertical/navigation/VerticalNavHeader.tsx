  ...
  return (
    <MenuHeaderWrapper className='nav-header' sx={{ pl: menuHeaderPaddingLeft() }}>
      {userNavMenuBranding ? (
        ...
        <LinkStyled href='/'>
          {/* ConfigFoundry branding: the Vuexy vendor mark is replaced with a plain
              monogram in the theme's primary color. Structure/sizing/collapse
              behavior below is unchanged Vuexy layout logic. */}
          <Box
            sx={{
              width: 34,
              height: 34,
          ...
          >
            <Typography sx={{ fontWeight: 700, fontSize: '1rem', lineHeight: 1 }}>CF</Typography>
          </Box>
