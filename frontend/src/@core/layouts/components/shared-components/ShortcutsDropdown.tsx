...
/**
 * Verbatim port of Vuexy's @core/layouts/components/shared-components/ShortcutsDropdown.tsx
 * -- only the "Add Shortcut" tooltip button was left non-functional (same as
 * vendor: it's decorative there too, no add-shortcut feature exists in either
 * source). `shortcuts` is populated by the caller from
 * navigation/vertical/index.ts's getPermittedQuickLinks() -- the same real,
 * permission-filtered nav data the sidebar uses, not a hardcoded/fake list.
 */
