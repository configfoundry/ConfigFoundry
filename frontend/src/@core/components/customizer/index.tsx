      ...
      <Drawer open={open} hideBackdrop anchor='right' variant='persistent'>
        ...
        <PerfectScrollbar options={{ wheelPropagation: false }}>
          ...
          <CustomizerSpacing className='customizer-body'>
            ...
            {/* Menu Layout radio (vertical/horizontal) removed -- HorizontalLayout
                was never ported (see @core/layouts/Layout.tsx), so this control
                would silently no-op. ConfigFoundry is vertical-nav only. */}
          ...
          {/* "Misc" section (RTL toggle) removed -- ConfigFoundry has no RTL
              requirement and the <Direction> wrapper component wasn't ported,
              so settings.direction stays 'ltr' always. */}
        </PerfectScrollbar>
      </Drawer>
    </div>
  )
