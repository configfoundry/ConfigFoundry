...
const themeConfig: ThemeConfig = {
  // ** Layout Configs
  templateName: 'ConfigFoundry' /* App Name -- was 'Vuexy' */,
  layout: 'vertical' /* vertical | horizontal -- ConfigFoundry only ships vertical, HorizontalLayout wasn't ported */,
  mode: 'dark' as Mode /* light | dark | semi-dark -- default matches the pre-existing ThemeModeProvider default */,
